...
{
    public class GH_ValueItem : GH_Param<IGH_Goo>, IGH_PreviewObject, IGH_BakeAwareObject, IGH_StateAwareObject
    {
        ...
        {
            get { return new Guid("0aeeb368-ba9d-4806-abee-d10bb3eff5fc"); }
        }
    }
}